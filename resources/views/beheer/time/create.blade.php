    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h1>Tijd toevoegen - {{ $zaal->name }}</h1>
            </div>
            <div class="card-body">
                <form action="{{ url()->current() }}" method="POST" id="submit-form">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="number" name="price"
                                       class="form-control @error('price') is-invalid @enderror" id="price" step="0.01"
                                       value="{{ old('price') }}">
                                @error('price')
                                <div class="invalid-feedback" role="alert">
                                    {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <a href="javascript:addMore()" class="btn btn-primary mr-3">Toevoegen & nog een toevoegen</a>
